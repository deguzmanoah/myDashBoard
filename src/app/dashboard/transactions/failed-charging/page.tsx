...
import { getTransactions, type ApiTransaction, exportFailedChargingAsCSV } from '@/lib/actions/transaction-actions';
...
export default async function FailedChargingPage({
  searchParams,
}: {
  ...
  return (
    <div className="space-y-5">
      <PageHeader
        title="Failed Charging"
        description="View and manage all failed charging transaction records."
      />
      ...
      <ServerTableActionBar
        ...
        exportAction={exportFailedChargingAsCSV}
      />
